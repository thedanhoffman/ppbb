...
gl = window.gl || {};
gl.snowplowStandardContext = {"schema":"iglu:com.gitlab/gitlab_standard/jsonschema/1-1-8","data":{"environment":"self-managed","source":"gitlab-rails","correlation_id":"01KY0Z22DV2XFQJHV07S434Q7T","extra":{},"user_id":null,"global_user_id":null,"user_type":null,"is_gitlab_team_member":null,"namespace_id":null,"ultimate_parent_namespace_id":null,"project_id":null,"feature_enabled_by_namespace_ids":null,"realm":"self-managed","deployment_type":"self-managed","context_generated_at":"2026-07-20T23:51:25.404Z","organization_id":1}};
...
<meta name="csrf-token" content="6Wrww5MPJ681APTqa7QEP58aQg_u_ixmEgWq2cg5pF_iCnkPzyRwYbSTdyI5Na3r6yAcbtnKcsFcQ6EQfZOphg" />
<meta name="csp-nonce" />
...
<form action="/users/sign_in" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="sVy9ZxJwlhnzVZhLpEk0RZIc8-bzEyQxpy_vuFGiQ6i6PDSrTlvB13LGG4P2yJ2R5iath8QnepbpaeRx5AhOcQ" autocomplete="off" /><input data-js-name="login" autocomplete="off" type="hidden" name="user[login]" id="user_login" />
...
</button><input type="hidden" name="authenticity_token" value="EMQtVyEaDljhlLiaAiBCJLGSkElmw3HUn87PX5TZJz0bpKSbfTFZlmAHO1JQoevwxajOKFH3L3PRiMSWIXMq5A" autocomplete="off" /></form>
...
</button><input type="hidden" name="authenticity_token" value="xxcqZq54bU87xUopTXPPHSA4OtUIOVbET8uOzEfBo8DMd6Oq8lM6gbpWyeEf8mbJVAJktD8NCGMBjYUF8muuGQ" autocomplete="off" /></form>
...
</button><input type="hidden" name="authenticity_token" value="t1pYLjbQRPG2DrmOvMI7YUMXcKSdAENVEXq6VnYq6d-8OtHiavsTPzedOkbuQ5K1Ny0uxao0HfJfPLGfw4DkBg" autocomplete="off" /></form>
