...
<meta name="csrf-token" content="zeWXAhCekBsXCAFVd2kKmaaWE4gYNSzd22X_FysM55vv8nneC-Q_LcYdhgdOQdBVdtemtwAPuTfm_XQKGIZQUA" />
<meta name="csp-nonce" />
...
<form action="/users/sign_in" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="LdyyKj14B1af-rThZNEuToy-gTfac7i3RUTxY1evCQIPy1z2JgKoYE7vM7Nd-fSCXP80CMJJLV143Hp-ZCW-yQ" autocomplete="off" /><input data-js-name="login" autocomplete="off" type="hidden" name="user[login]" id="user_login" />
...
</button><input type="hidden" name="authenticity_token" value="kkRWymqMKgcbEQewgyMEKc5AW1AZo-vAPP1Fx_xaHD6wU7gWcfaFMcoEgOK6C97lHgHubwGZfioBZc7az9Cr9Q" autocomplete="off" /></form>
...
</button><input type="hidden" name="authenticity_token" value="FX7tBN2Hqv78PawSMMmH8aWSS5DP7F9BfUv690ezik43aQPYxv0FyC0oK0AJ4V09ddP-r9fWyqtA03HqdDk9hQ" autocomplete="off" /></form>
...
</button><input type="hidden" name="authenticity_token" value="eu4nDV9ZRfW6C7Ce899dAH-Q0KuVxoqmaHCdHCegJ_JY-cnRRCPqw2seN8zK94fMr9FllI38H0xV6BYBFCqQOQ" autocomplete="off" /></form>
